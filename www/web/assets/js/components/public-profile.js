...
function applySupportPresentation(container, avatar, supporterProfile) {
  applyOverlay(avatar, "avatar-frame-overlay", supporterProfile?.selected_icon_frame_asset_path || null);
...
export function initPublicProfileModal(app) {
  ...
  const openAvatar = () => {
    ...
    showAvatarDetail({
      ...
      selectedIconFrameAssetPath: currentUser.supporter_profile?.selected_icon_frame_asset_path || null,
    }, app);
  };
