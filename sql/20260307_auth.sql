CREATE TABLE users (
    ...
    force_logout_after DATETIME(6) NULL,
    deleted_at DATETIME(6) NULL,
    created_at DATETIME(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6),
    updated_at DATETIME(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6),
    PRIMARY KEY (id),
    UNIQUE KEY uq_users_user_key (user_key),
    UNIQUE KEY uq_users_primary_email (primary_email),
...
CREATE TABLE email_verifications (
    ...
    purpose ENUM('signup', 'email_change', '2fa_setup') NOT NULL,
...
ALTER TABLE images
    ...
    ADD KEY idx_images_is_public (is_public),
